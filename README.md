# Tool Auto BWC_WUKONG Bot NodeJS by Lượm Airdrop

**Tool phát triển và chia sẻ miễn phí tại kênh Telegram [Lượm Airdrop Auto](https://t.me/autoairdropref)**

## 🕹️ Link BWC_WUKONG:[ Click](https://t.me/bwcwukong_bot/Play?startapp=1858549801)

## 🛠️ Hướng dẫn cài đặt

> Yêu cầu đã cài đặt NodeJS

- Bước 1: Tải về phiên bản mới nhất của tool [tại đây ⬇️](https://github.com/donguyen82/Bwc_Wukong/archive/refs/heads/main.zip)
...
| Lệnh                | Chức năng                               |
| ------------------- | --------------------------------------- |
| `npm run bwc`       | Dùng để chạy chơi game không dùng proxy |
| `npm run bwc-proxy` | Dùng để chạy chơi game có dùng proxy    |
...
❗️ Bạn có thể lấy data 1 kèo bất kì để chạy
...
<details>
<summary>v1.0.0 - 📅 14/09/2024</summary>
